...
PRIORITY="$(kdialog --geometry 100x100 --icon=/usr/share/icons/hicolor/scalable/apps/ks-concatenate-media-file.svgz --caption="Concatenate Media Files with Same Codec" \
