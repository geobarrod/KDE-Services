...
qdbus $DBUSREF close
kdialog --icon=/usr/share/icons/hicolor/512x512/apps/ks-search-string.png --caption="Search By String: $(cat /tmp/SearchByString|wc -l) matching entries with ($STRING)" \
