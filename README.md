...
Option A:
1. servicemenuinstaller install kde-services-3.1.0.tar.gz

Option B:
1. tar xf kde-services-3.1.0.tar.gz
2. cd kde-services-3.1.0
3. make install
...
Option A:
1. servicemenuinstaller uninstall kde-services-3.1.0.tar.gz
